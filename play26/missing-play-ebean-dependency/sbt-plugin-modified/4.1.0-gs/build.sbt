...
lazy val sbtPlayEbeanDeps = Seq("io.ebean" % "ebean-agent" % Versions.ebeanAgent)
...
//GS  val version = (Keys.version in core).value
  val version = (Keys.version in ThisBuild).value //GS
